...
export default function Navbar() {
  ...
  return (
    <nav className="container mx-auto relative z-[1000] py-6 px-7 flex items-center justify-between max-lg:w-full bg-white">
      ...
      <div className={`right-side flex items-center gap-6 max-lg:absolute max-lg:z-[50] max-lg:flex-col-reverse transition-all top-[100%] ${ exchange ? 'max-lg:right-[0] max-lg:opacity-100' : 'max-lg:right-[-100%] max-lg:opacity-0' } max-lg:right-0 max-lg:w-full max-lg:bg-slate-900 max-lg:py-5 max-lg:rounded-[12px] max-lg:shadow-md`}>
